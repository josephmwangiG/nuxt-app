    ...
    <div class="py-12 px-6 font-['poppins'] bg-gray-100 h-[100vh]">
        ...
        <div
            ...
            <div class="col-span-1 hidden lg:block" style="">
                <img class="h-full object-cover" src="~/assets/img/login.jpg" alt="">
            </div>
            <div class="col-span-2 p-6 lg:p-12">
                <h2 class="text-3xl text-semibold">Sign in to platform</h2>
                ...
                <form action="py-16 my-12 flex">
                    ...
                    <div class="grid grid-cols-2">
                        <div class="py-2 flex items-center">
                            <input type="checkbox" class="border border-gray-300 mr-3" id="remember-me">
                            <label class="text-gray-500 text-sm" for="remember-me">Remember me</label>
                        </div>
                        <div class="py-2 text-right">
                            <label class="text-blue-500 text-sm">Lost Password?</label>
                        </div>
                    </div>

                    <div class="py-4">
                        <span class="bg-blue-500 p-3 semibold text-white rounded-lg">Login to your account</span>
                    </div>

                    <div class="py-2">
                        Not registered? <NuxtLink :to="$routes.register" class="text-blue-500 text-sm">Create
                            account</NuxtLink>
                    </div>
                </form>
            </div>
