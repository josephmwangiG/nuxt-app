<template>
    <div class="py-12 px-6 font-['poppins'] bg-gray-100 h-[100vh]">
        <div class="header py-10 text-center">
            <NuxtLink :to="$routes.home"> <span class="logos inline-block">
                    <svg class="inline-block" xmlns="http://www.w3.org/2000/svg" height="32" viewBox="0 0 32 32"
                        fill="#0069ff">
                        <path
        ...
        <div
            class="grid lg:grid-cols-3 grid-cols-1 lg:w-[60%] mx-auto rounded-lg overflow-hidden bg-white shadow-lg shadow-slate-100">
            <div class="col-span-1 hidden lg:block" style="">
                <img class="h-full object-cover" src="~/assets/img/create-account.jpg" alt="">
            </div>
            <div class="col-span-2 p-6 lg:p-12">
                <h2 class="text-3xl text-semibold">Create an Account</h2>

                <form action="py-16 my-12 flex">
                    <div class="py-2 mt-6 space-y-2">
                        <label class="text-gray-500 text-sm" for="email">Email</label>
                        <input type="text"
                            class="border border-gray-300 rounded-lg w-full px-3 py-2 outline-1 outline-blue-400"
                            placeholder="Enter your email">
                    </div>
                    <div class="py-2 space-y-2">
                        <label class="text-gray-500 text-sm" for="password">Your password</label>
                        <input type="password"
                            class="border border-gray-300 rounded-lg w-full px-3 py-2 outline-1 outline-blue-400"
                            placeholder="Enter your password">
                    </div>
                    <div class="py-2 space-y-2">
                        <label class="text-gray-500 text-sm" for="password">Confirm password</label>
                        <input type="password"
                            class="border border-gray-300 rounded-lg w-full px-3 py-2 outline-1 outline-blue-400"
                            placeholder="Confirm password">
                    </div>
                    <div class="py-2 flex items-center">
                        <input type="checkbox" class="border border-gray-300 mr-3" id="t-and-c">
                        <label class="text-gray-500 text-sm" for="t-and-c"> I accept the <span
                                class="text-blue-500 text-sm">Terms and Conditions</span> </label>
                    </div>


                    <div class="py-4">
                        <span class="bg-blue-500 p-3 semibold text-white rounded-lg">Create account</span>
                    </div>

                    <div class="py-2">
                        Already have an account? <NuxtLink :to="$routes.login" class="text-blue-500 text-sm">Login here
                        </NuxtLink>
                    </div>
                </form>
            </div>
