<template>
    <nav class="w-full shadow-b shadow-sm shadow-gray-300">
        <div class="container px-4 lg:px-20 h-20 flex items-center justify-between mx-auto">
            <div class="menus h-20 flex items-center space-x-4">
                ...
                <ul class="space-x-4 hidden lg:inline-block mt">
                    <li class="inline-block hover:bg-gray-200 p-2 rounded transition duration-500">
                    ...
                    <li class="inline-block hover:bg-gray-200 p-2 rounded transition duration-500">
                        <NuxtLink :to="$routes.businesses">
                            Businesses
                        </NuxtLink>
                        <a href=""></a>
                    </li>
                    <li class="inline-block hover:bg-gray-200 p-2 rounded transition duration-500">
                        <NuxtLink :to="$routes.pricing">
                            Pricing
                        </NuxtLink>
                    </li>
                </ul>
            ...
            <div class="buttons flex justify-end space-x-4">
                <NuxtLink :to="$routes.login">
                    <span class="p-2 hover:bg-gray-200 rounded transition duration-500 hidden lg:inline-block">Log in
                    </span>
                </NuxtLink>
                <NuxtLink :to="$routes.register">
                    <span class="bg-blue-600 text-white p-2 rounded hidden lg:inline-block">Sign up</span>
                </NuxtLink>
                <span class="inline-block lg:hidden p-2">Menu</span>
            </div>
        </div>
    </nav>
</template>
